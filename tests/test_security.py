...
class TestSecurityAndRobustness:
    ...
    def test_malicious_json_injection(self):
        ...
        for malicious_input in malicious_inputs:
            result = toolkit.run_tool(
                "vulnerable_tool", {"user_input": malicious_input}
            )
    ...
    def test_type_confusion_attacks(self):
        ...
        result = toolkit.run_tool(
            "typed_processor", {"number": 42, "text": "hello", "flag": True}
        )
        assert result["processed"] is True

        confusion_attempts = [
            {"number": "42", "text": "hello", "flag": True},
            {"number": 42, "text": 123, "flag": True},
            {"number": 42, "text": "hello", "flag": "true"},
            {"number": [42], "text": "hello", "flag": True},
            {"number": {"value": 42}, "text": "hello", "flag": True},
        ]
    ...
    def test_argument_validation_bypass(self):
        ...
        result = toolkit.run_tool(
            "strict_validator", {"positive_number": 42, "email": "test@example.com"}
        )
        ...
        bypass_attempts = [
            ...
            {"positive_number": "42", "email": "test@example.com"},
        ]
    ...
    def test_serialization_attacks(self):
        ...
        def data_serializer(data: dict) -> dict:
            ...
            safe_data = {
                k: v for k, v in data.items() if isinstance(k, str) and len(k) < 100
            }
    ...
    def test_memory_exhaustion_protection(self):
        ...
        def memory_tool(size_mb: int) -> dict:
            ...
            safe_size = min(size_mb, 10)
            data = bytearray(safe_size * 1024 * 1024)
    ...
    def test_input_sanitization(self):
        ...
        for test_input in test_inputs:
            ...
            if "onerror=" in test_input:
                assert "onerror=" in result["sanitized"], (
                    "onerror should be escaped but present"
                )
    ...
    def test_injection_prevention(self):
        ...
        safe_result = toolkit.run_tool(
            "query_builder", {"table_name": "users", "condition": "age > 18"}
        )
        ...
        injection_attempts = [
            ...
            {
                "table_name": "users",
                "condition": "id = 1 UNION SELECT * FROM passwords",
            },
